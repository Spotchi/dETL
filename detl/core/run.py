...
class Run(_MLflowObject):
    ...
    def __init__(self, run_info, run_data, identity):
        # TODO : I suppose you're right
        # if run_info is None:
    ...
    # def __init__(self, result_value, result_identity, run_uuid):
    #
    #     self._res_value = result_value
    #     self._res_id = result_identity
